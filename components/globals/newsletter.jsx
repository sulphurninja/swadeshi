...
export function Newsletter() {
    ...
    return (
        <div className="max-w-md  w-full  md:mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
            <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
                Contact Us
            </h2>
            <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
               Fill in the following details to contact Swadeshi Standard Certificate
            </p>
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <Input id="mobNo" placeholder="Enter Mob No" type="number" />
                </LabelInputContainer>
                <LabelInputContainer>
